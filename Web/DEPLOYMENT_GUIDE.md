...
Deploy dari folder master yang sudah bersih:

```
✅ master_site/index.html
✅ master_site/optimized_styles.css
✅ master_site/optimized_script.js
✅ master_site/assets/
✅ master_site/robots.txt
✅ master_site/sitemap.xml
✅ master_site/privacy-policy.html
✅ master_site/terms-of-service.html
✅ master_site/404.html
```

**Important:** Upload isi `master_site/` ke root hosting (mis. `public_html/`) agar path `assets/...` tetap valid.
...
# 2. Upload isi folder master_site/ ke root hosting
# (index.html, optimized_styles.css, optimized_script.js, assets/, robots.txt, sitemap.xml, dll.)
