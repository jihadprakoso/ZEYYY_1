...
- CSS has a global transition rule on `*` that can create unnecessary work and odd “color fade” effects across the entire page: [optimized_styles.css](file:///d:/Data%20User/Documents/Jihad/Web/optimized_styles.css#L130-L140).
- JavaScript globally logs runtime errors via `console.warn`, which is usually undesirable on production sites: [optimized_script.js](file:///d:/Data%20User/Documents/Jihad/Web/optimized_script.js#L60-L64).
